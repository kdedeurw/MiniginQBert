...
void TextComponent::Render() const
{
	...
	{
		const Vector3& pos = m_pGameObject->GetLocalTransform().GetPosition();
		Renderer::GetInstance().RenderTexture(m_pTextureData->GetSDLTexture(), pos.x + m_Offset.x, pos.y + m_Offset.y);
	}
}
...
Texture* TextComponent::GetTextureData(SDL_Texture* pTexture)
{
